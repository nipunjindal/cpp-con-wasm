...
var wasmBinaryFile;
  wasmBinaryFile = 'sample-logger-threading.wasm';
...
function js_console(text) { const jsString = UTF8ToString(text); console.log(jsString); }
  ...
  var PThread = {unusedWorkers:[],runningWorkers:[],tlsInitFunctions:[],pthreads:{},init:function() {
        ...
        var pthreadMainJs = locateFile('sample-logger-threading.worker.js');
...
var ___start_em_js = Module['___start_em_js'] = 5588;
var ___stop_em_js = Module['___stop_em_js'] = 5674;
